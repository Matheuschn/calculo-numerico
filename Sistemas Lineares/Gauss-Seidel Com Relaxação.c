...
void gaussSeidelComRelaxacao(int n, double a[n][n], double b[n], double error, double w) {
...
int main() {
    ...
    scanf("%lf", &error);
    double w;
    printf("Insira o fator de relaxação: ");
    scanf("%lf", &w);
    double x[n];
    for (int i = 0; i < n; i++) {
    ...
    gaussSeidelComRelaxacao(n, a, b, error, w); 
